...
module.exports.request = (request, response) => {
  response.render('tokenrequest')
}

module.exports.tokenCallback = [login.ensureLoggedIn(), (request, response) => {
  response.render('tokengrant',
    {
